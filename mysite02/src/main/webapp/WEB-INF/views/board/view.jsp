		...
		<div id="content">
			<div id="board" class="board-form">
				...
				<div class="bottom">
					...
					<a href="${pageContext.servletContext.contextPath }/board?a=rewrite&no=${no1 }&title=${title}&group_no=${param.group_no}&order_no=${param.order_no}&depth=${param.depth}">답글</a>
